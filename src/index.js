/**
 * El paquete react-redux nos proporciona un Provider
 * para poder encapsular nuestros componentes por medio 
 * de un connect para poder transmitir la información que
...
const initialState = {
    "user": {}, //traemos la data inicial del usuario
    "playing": {}, //sabremos si estamos reproduciendo o no un video
    "mylist": [],
    "trends": [
        {
            "id": 2,
